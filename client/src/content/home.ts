...
export const painPointsContent = {
  title: "What Most Windows Don't Tell You",
  blocks: [
    {
      ...
      image: {
        src: "https://d2xsxph8kpxj0f.cloudfront.net/310519663372502898/548bPj3wr3XkSkZDY6HRRh/coating-texture-detail-cQierVMnUYNTtRvJzG8yoC.webp",
        alt: "Surface Coating",
      },
      standardLabel: "Polygon Standard:",
      bullets: [
        "Certified low-VOC powder coating",
        "Controlled finishing process",
        "Surface compliance documentation",
      ],
    },
    {
      ...
      image: {
        ...
        alt: "Acoustic Protection",
      },
      standardLabel: "Polygon Standard:",
      bullets: [
        "Multi-point sealing",
        "Compression gasket system",
    ...
    },
    {
      ...
      image: {
        src: "https://d2xsxph8kpxj0f.cloudfront.net/310519663372502898/548bPj3wr3XkSkZDY6HRRh/thermal-break-profile-DD7VSH4T5f55ikvuesTyAM.webp",
        alt: "Thermal Break",
      },
      standardLabel: "Polygon Standard:",
      bullets: [
        "Thermal break systems",
        "Optimized Uw performance",
        "Balanced internal climate",
      ],
    },
  ],
} as const;
